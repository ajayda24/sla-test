...
export default function ListDataJobPosition({ list = [], editData, deleteData, loading, titles = [] }) {
        ...
        {list.map((l, index) => (
          <React.Fragment key={index}>
            ...
            <div className="flex gap-3 min-w-fit ">
              {checkAccess("Job Possition", "job-possition-edit") ? (
                <button
              ...
              {checkAccess("Job Possition", "job-possition-delete") ? (
                <button
                ...
                <p className="p-1 px-2 rounded-md ring-1 text-white bg-gray-200">
