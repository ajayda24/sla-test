...
export default function ProjectQuotationCostSheet() {
  return (
    <>
      <div className="flex flex-col p-5 gap-3 justify-between">
        <h2 className="text-xl font-semibold">Quotation Cost Sheet</h2>
        <p>View the details quotation cost sheet included in this project.</p>
      </div>
